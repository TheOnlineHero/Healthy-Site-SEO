...
if ( !function_exists('hsc_register_required_plugins') ) {
	...
	function hsc_register_required_plugins() {
		...
		$plugins = array(
			...
			array(
				'name'     => 'WP Content Source Control',
				'slug'     => 'wp-source-control',
				'required' => true
			),
			array(
			...
			array(
				'name'     => 'Clever SEO Keywords',
				'slug'     => 'clever-seo-keywords',
				'required' => false
			),
			array(
			...
			array(
				'name'		 => 'View WP Error Log',
				'slug'		 => 'view-wp-error-log',
				'required' => true
			),
			array(
				'name'		 => 'WP-Optimize',
			...
			array(
				'name'     => 'My Mapped Locations',
				'slug'     => 'my-mapped-locations',
				'required' => false
			),
			array(
			...
			array(
				'name'     => 'Next Gen Gallery',
				'slug'     => 'nextgen-gallery',
				'required' => false
			),
			array(
				'name'     => 'Facebook Photo Fetcher',
				'slug'     => 'facebook-photo-fetcher',
				'required' => false
			),
			array(
...
class HealthySiteMenu {
  ...
  function hsc_links() {
      ...
      $this->add_sub_menu("Quick Sprout", "http://www.quicksprout.com/", "hscl", "hsclqs", array('target' => '_blank'));
